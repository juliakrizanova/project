iterate_over_2d_list([], []).
iterate_over_2d_list([Row | Rest], Result) :-   process_row(Row, ProcessedRow),
                                                iterate_over_2d_list(Rest, RestResult),
                                                append(ProcessedRow, RestResult, Result).


process_row([], []).
process_row([T | Ts], [Result | Rest]) :-   process_T(T, Result),
                                            process_row(Ts, Rest).
